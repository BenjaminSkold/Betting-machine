...
// used everywhere a match's current edge needs to show up in a list.
export default function EdgeBadge({ score }: { score: ConfluenceScore }) {
  ...
  return (
    <div className="flex flex-col items-end gap-0.5">
      ...
      >
        {positive ? "+" : ""}
        <AnimatedNumber value={score.edge * 100} format={(n) => n.toFixed(1)} />
        pp
      </div>
