...
// No checkpoints stored yet, so every due checkpoint should come back as
// "needs writing".
const noExistingCheckpoints = () => new Set();
...
async function main() {
  ...
  const due = planSnapshots(noExistingCheckpoints(), fakeMarket(0.5), fakeMarket(0.25), fakeMarket(0.25), kickoffTime);
  ...
  const due60 = planSnapshots(noExistingCheckpoints(), fakeMarket(0.5), fakeMarket(0.25), fakeMarket(0.25), new Date(Date.now() + 62 * 60 * 1000));
  ...
  const duePast = planSnapshots(noExistingCheckpoints(), fakeMarket(0.5), fakeMarket(0.25), fakeMarket(0.25), new Date(Date.now() - 5 * 60 * 1000));
